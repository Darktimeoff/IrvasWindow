...
/* harmony import */ var _modules_modal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modal.component */ "./src/js/modules/modal.component.js");
/* harmony import */ var _modules_tabs_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/tabs.component */ "./src/js/modules/tabs.component.js");
/* harmony import */ var _modules_timer_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/timer.component */ "./src/js/modules/timer.component.js");
/* harmony import */ var _modules_gallery_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/gallery.component */ "./src/js/modules/gallery.component.js");
/* harmony import */ var _modules_form_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/form.component */ "./src/js/modules/form.component.js");
...
document.addEventListener('DOMContentLoaded', function () {
  var popupEng = new _modules_modal_component__WEBPACK_IMPORTED_MODULE_2__["default"]('.popup_engineer', '.popup_engineer_btn').init();
  var popup = new _modules_modal_component__WEBPACK_IMPORTED_MODULE_2__["default"]('.popup', '.phone_link');
  popup.modalDelegation({
    useButtonsClass: true
  }); //popup.showWithDelay(1000);

  var popupCalc = new _modules_modal_component__WEBPACK_IMPORTED_MODULE_2__["default"]('.popup_calc', '.popup_calc_btn');
  popupCalc.modalDelegation({
    useWrapperDelegationSel: '.glazing'
  });

  popupCalc.onShow = function () {
    var popupCalcProfile = new _modules_modal_component__WEBPACK_IMPORTED_MODULE_2__["default"]('.popup_calc_profile', '.popup_calc_button');
    ...
    popupCalcProfile.onShow = function () {
      ...
      var data = {};
      document.querySelector('.popup_calc').querySelectorAll('input').forEach(function (input) {
        data[input.getAttribute('id')] = input.value;
      });
      localStorage.setItem('popCalcData', JSON.stringify(data));
      popupCalc.hide();
      var popCalcEnd = new _modules_modal_component__WEBPACK_IMPORTED_MODULE_2__["default"]('.popup_calc_end', '.popup_calc_profile_button');
      popCalcEnd.init();

      popCalcEnd.onShow = function () {
        popupCalcProfile.hide();

        var input = _this.modal.querySelectorAll('.checkbox');

        var select = _this.modal.querySelector('select');
  ...
  var glazingTabs = new _modules_tabs_component__WEBPACK_IMPORTED_MODULE_3__["default"]('.glazing', '.glazing_slider', '.glazing_block', '.glazing', '.glazing_content', 'active', 'a').init();
  var decorationTabs = new _modules_tabs_component__WEBPACK_IMPORTED_MODULE_3__["default"]('.decoration', '.decoration_slider', '.decoration_item', '.decoration_content .row', 'div', 'after_click', 'div').init();
  var timer = new _modules_timer_component__WEBPACK_IMPORTED_MODULE_4__["default"]('2020-08-15', '#timer', '#days', '#hours', '#minutes', '#seconds').init();
  var gallery = new _modules_gallery_component__WEBPACK_IMPORTED_MODULE_5__["default"]('.works').init({
  ...
  var popCalcTabs = new _modules_tabs_component__WEBPACK_IMPORTED_MODULE_3__["default"]('.popup_calc', '.balcon_icons', 'img', '.big_img', 'img', 'do_image_more', '.balcon_icons_img', false, 'show-inline').init();
  Object(_modules_form_component__WEBPACK_IMPORTED_MODULE_6__["forms"])('form', 'https://jsonplaceholder.typicode.com/posts');
});

/***/ }),

/***/ "./src/js/modules/form.component.js":
/*!******************************************!*\
  !*** ./src/js/modules/form.component.js ***!
  \******************************************/
/*! exports provided: default, forms */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _validators_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./validators.component */ "./src/js/modules/validators.component.js");
/* harmony import */ var _services_request_services__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./../services/request.services */ "./src/js/services/request.services.js");
  ...
  _createClass(Form, [{
    ...
    value: function isValid() {
      ...
      Object.keys(this.controls).forEach(function (control) {
        ...
        isValid ? _clearError(_this2.form[control]) : _setError(_this2.form[control]);
...
function forms(selectorForms, urlSend) {
  var forms = document.querySelectorAll(selectorForms);
  var message = {
  ...
  function _formSubmitHandler(e) {
    var form;
    return regeneratorRuntime.async(function _formSubmitHandler$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            form = new Form(e.target, {
              user_name: [_validators_component__WEBPACK_IMPORTED_MODULE_9__["default"].required],
              user_phone: [_validators_component__WEBPACK_IMPORTED_MODULE_9__["default"].required, _validators_component__WEBPACK_IMPORTED_MODULE_9__["default"].minLength(8)]
            });

            if (form.isValid()) {
              _services_request_services__WEBPACK_IMPORTED_MODULE_10__["default"].postRequest(_objectSpread({}, form.value()), urlSend).then(function (response) {
...
/***/ "./src/js/modules/modal.component.js":
/*!*******************************************!*\
  !*** ./src/js/modules/modal.component.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _form_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./form.component */ "./src/js/modules/form.component.js");
/* harmony import */ var _validators_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./validators.component */ "./src/js/modules/validators.component.js");
...
function () {
  ...
  _createClass(Modal, [{
    key: "modalDelegation",
    value: function modalDelegation(options) {
    ...
    key: "emulatedClick",
    value: function emulatedClick() {
      _typeof(this.buttonOpen) === 'object' ? this.buttonOpen[0].click() : this.buttonOpen.click();
    }
  }, {
    key: "onShow",
...
/***/ "./src/js/modules/tabs.component.js":
/*!******************************************!*\
  !*** ./src/js/modules/tabs.component.js ***!
  \******************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function () {
  function Tabs(section, parentTab, tab, parentTabContent, tabContent, activeClass, activeElement) {
    var nameClassTabAndContentSame = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : true;
    var activeTabContentClass = arguments.length > 8 && arguments[8] !== undefined ? arguments[8] : 'show';
...
function _tabClickHandler(e) {
  var target = e.target.closest(this.tab);
  var link = target.querySelector(this.activeElement);

  if (this.nameClassTabAndContentSame && target && target.classList.contains(this.tab.slice(1))) {
    var postion = link.className.match(/_/).index;
    var tabContentName = link.className.slice(0, postion);
  ...
  if (!this.nameClassTabAndContentSame && e.target.closest(this.activeElement)) {
    var tab = e.target.closest(this.activeElement);

    var ind = _toConsumableArray(this.parentTab.querySelectorAll(this.tab)).indexOf(e.target);
...
/***/ "./src/js/modules/timer.component.js":
/*!*******************************************!*\
  !*** ./src/js/modules/timer.component.js ***!
  \*******************************************/
/*! exports provided: default */
...
/*#__PURE__*/
function () {
  function Timer(deadline, parentSectionSel, daysSel, hoursSel, minutesSel, secondsSel) {
  ...
  _createClass(Timer, [{
    ...
    key: "calcLeftDate",
    value: function calcLeftDate(deadline) {
...
function _render() {
  var _calcLeftTime$call = _calcLeftTime.call(this, this.deadline),
      days = _calcLeftTime$call.days,
      hours = _calcLeftTime$call.hours,
      minutes = _calcLeftTime$call.minutes,
      seconds = _calcLeftTime$call.seconds;
...
function _calcLeftTime(deadline) {
  var t = +new Date(deadline) - Date.now();
...
/***/ "./src/js/modules/validators.component.js":
/*!************************************************!*\
  !*** ./src/js/modules/validators.component.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Validators; });
...
/***/ "./src/js/services/request.services.js":
/*!*********************************************!*\
  !*** ./src/js/services/request.services.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RequestService; });
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", _useRequest(request));
...
function _useRequest(request) {
  var response;
  return regeneratorRuntime.async(function _useRequest$(_context2) {
    while (1) {
